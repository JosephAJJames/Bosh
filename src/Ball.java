...
public class Ball
{
	...
	protected Vector velocity = new Vector(0, 0);			//Vector for velocity of a Ball.
	protected double size;				// The diameter of this Ball.
	protected int layer;					// The layer of this ball is on.
	protected String colour;				// The colour of this Ball.
	 ...
	 */
	public Ball(double x, double y, int X_vel, int Y_vel, double diameter, String col)
	{
		this.xPosition = x;
		this.yPosition = y;
		this.size = diameter;
	 ...
	 */
	public Ball(double x, double y, int X_vel, int Y_vel, double diameter, String col, int layer)
	{
		this.xPosition = x;
		this.yPosition = y;
		this.size = diameter;
